...
function showQuote() {
  ...
  newQuote1.textContent="By"+randomQuote.author;

  clearAll();
  //document.querySelector('.joke-content').appendChild(newJoke);
  container.appendChild(newQuote);
  container.appendChild(newQuote1);
}
...
function showRiddle() {
  ...
  const newRiddleQ = document.createElement('p');
  newRiddleQ.textContent= question;

  const newRiddleA = document.createElement('p');
  newRiddleA.textContent= answer;
  newRiddleA.setAttribute('id','riddle-answer');
  newRiddleA.textContent= answer;
  newRiddleA.hidden = true;
  console.log(newRiddleA);

  clearAll();

  document.querySelector('.riddle-content').appendChild(newRiddleQ);
  document.querySelector('.riddle-content').appendChild(newRiddleA);
}
